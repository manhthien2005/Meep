...
---
**T4 · feat(space): SpaceContextBottomSheet + currentSpaceProvider + SpaceContextBadge** ✅ MERGED (#135 — 2026-06-01)

| | |
|---|---|
| Assignee | ThienPDM |
| Estimate | M (~8h) — actual ~5h |
| Branch | `feature/ThienPDM/space-camera-context-t4t5` |
| Blocked by | ✅ T2, T3, gate changes — all cleared |
...
---
**T5 · feat(space): Feed per Space** ✅ MERGED (#135 — 2026-06-01, gộp cùng T4)

| | |
|---|---|
| Assignee | ThienPDM |
| Estimate | S (~2h) — actual ~30 phút (chỉ cần router fix vì `HomeScreen.spaceId` đã có từ PR #195) |
| Branch | `feature/ThienPDM/space-camera-context-t4t5` (cùng T4) |
| Blocked by | ✅ T4 đã DONE |
...
---
**T10b · feat(space): SpaceManagementSheet — Leave / Delete / Kick / Transfer UI** ✅ MERGED (#137 — 2026-06-01)

| | |
|---|---|
| Assignee | ThienPDM |
| Estimate | M (~8h) — actual ~4h |
| Branch | `feature/ThienPDM/space-management-ui` |
| Blocked by | ✅ T7 (CF), T5 (HomeScreen.spaceId) — all cleared |
